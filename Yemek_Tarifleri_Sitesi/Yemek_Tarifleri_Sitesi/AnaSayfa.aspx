                ...
                <table class="auto-style1">
                    <tr>
                        <td style="background-color: #FFCCCC; text-align: center;">
                            ...
                            <a href="YemekDetay.aspx?Yemekid=<%# Eval("YemekId")%>"><asp:Label ID="Label3" runat="server" style="font-weight: 700; font-size: large; text-align: center;" Text='<%# Eval("YemekAd") %>'></asp:Label></a>
                    ...
                    <tr>
                        <td>
                            <asp:Image ID="Image2" runat="server" Height="186px" ImageUrl='<%# Eval("YemekResim") %>' Width="420px" />
                        </td>
                    </tr>
                    <tr>
